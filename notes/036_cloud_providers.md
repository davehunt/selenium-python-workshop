1. Run tests using SauceLabs: `pytest -n auto --driver SauceLabs --variables solutions/variables.json --capability browserName firefox solutions/032_page_objects.py`
